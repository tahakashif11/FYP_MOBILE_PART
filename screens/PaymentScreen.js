...
const Secret_key = 'sk_test_51MiGf3BnVuFOu736n5I6ic5bU4e8fY8y5b5BcpVQQxqWm7myIWtkxnE73o7HnVU1HoUV8vYCNVliIbHxt9EHZzyQ00xF64JhYf'
const STRIPE_PUBLISHABLE_KEY = 'pk_test_51MiGf3BnVuFOu736gPXWB83rj96rTbOt0VL1dEvgsZ0KaM1KcU7JH2jftmFde0w6YbUg7DglnRoMxxhBih1oPp3j00VO7sH7Ba'
// create a component
const CURRENCY = 'USD';
var CARD_TOKEN = null;
...
const PaymentScreen = () => {
  ...
  const charges = async () => {
    ...
    const card = {
      ...
      'currency': CURRENCY,
      'source': CARD_TOKEN,
      'description': "ProThenics Payment"
    };
